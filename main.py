...
posts: list[dict] = [
    {
        "id": 1,
        "author": "Amulya Kundalia",
        "title": "FastAPI",
        "content": "Currently learning FastAPI",
...
def home(request: Request):
    ...
    )  # request,template_name,context_dictionary(posts,title)
